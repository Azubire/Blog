...
<template>
  <section>
    <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6 text-white">
      <div class="mx-auto max-w-screen-md sm:text-center">
        <h2 class="mb-4 text-3xl tracking-tight font-extrabold sm:text-4xl">
          Sign up for our newsletter
        </h2>
        <p class="mx-auto mb-8 max-w-2xl font-light md:mb-12 sm:text-xl">
        ...
        <form action="#">
          <div class="items-center mx-auto mb-3 space-y-4 max-w-screen-sm sm:flex sm:space-y-0">
            <div class="relative w-full">
              ...
              <input
                class="block p-3 pl-10 w-full text-sm bg-gray-50 text-gray-900 rounded-lg border border-gray-300 sm:rounded-none sm:rounded-l-lg focus:ring-primary-500 focus:border-primary-500"

...
<template>
  <section id="comment" class="not-format">
    <div class="flex justify-between items-center mb-6">
      <h2 v-if="showComments" class="text-lg lg:text-2xl font-bold text-gray-900">
    ...
    <article v-if="showComments" class="p-6 mb-6 text-base bg-white rounded-lg">
